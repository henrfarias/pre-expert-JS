...
describe('todoService', () => {
    ...
    describe('#list', () => {
        const mockDatabase = [
            ...
            name: 'XuxaDaSilva',
            age: 90,                                                                                              
            meta: { revision: 0, created: 1611259254123, version: 0 },
            '$loki': 1
            },
        ]
    ...
    describe('#create', () => {
        ...
        it('shouldn\'t save todo item with invalid data', () => {
            ...
            Reflect.deleteProperty(data, 'id') // deleta a propriedade do objeto sem interferir no 'ciclo de performance do JS'
            const expected = {
                error: {
        ...
        it('should save todo item with pending status', () => {
            ...
            it('should save todo item with late status when the property is further than today', () => {
                const properties = {
                    text: 'I must walk my dog',
                    when: new Date('2020-12-10 12:00 GMT-0')
                }
                const expectedId = '000001'
